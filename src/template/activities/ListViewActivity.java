...
public class ListViewActivity extends DraggableActivity {
    ...
    public ListViewActivity() throws IOException {
        ...
        classCustomTemplate = codeGenerator.provideTemplateForName("templates/activityTemplates/ListViewCustomAdapterActivity");
        classCustomFragment = codeGenerator.provideTemplateForName("templates/activityTemplates/ListViewCustomAdapterFragment");
        layoutTemplate = codeGenerator.provideTemplateForName("templates/activityTemplates/ListViewLayout");
        ...
        rowCustomTemplate = codeGenerator.provideTemplateForName("templates/activityTemplates/AdapterViewCustomItem");
        classArrayTemplate = codeGenerator.provideTemplateForName("templates/activityTemplates/ListViewArrayAdapterActivity");
        classArrayFragment = codeGenerator.provideTemplateForName("templates/activityTemplates/ListViewArrayAdapterFragment");
        rowArrayTemplate = codeGenerator.provideTemplateForName("templates/activityTemplates/AdapterViewArrayItem");
    ...
    private void initialize() {
        ...
        super.setName("ListViewActivity"+ GraphHandler.getInstance().getActivityIndex(DragControllerType.listView,"ListViewActivity"));
        adapterType = "String";
        loadInspector();
    }
    ...
    public void generateRow() throws IOException {
        ...
        codeGenerator.generateXMLFile(projectHandler.getProjectPath()+"/app/src/main/res/layout/"
                +generateLayoutName(super.getName())+"_row.xml",template,generateLayoutName(super.getName())+"_row");
    }
