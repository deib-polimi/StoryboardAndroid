...
public class BottomNavigationActivity extends DraggableActivity {
    ...
    public BottomNavigationActivity() throws IOException {
        ...
        classTemplate = codeGenerator.provideTemplateForName("templates/activityTemplates/BottomNavigationActivity");
        layoutTemplate = codeGenerator.provideTemplateForName("templates/activityTemplates/BottomNavigationLayout");
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("DraggableActivity.fxml"));
    ...
    private void initialize() {
        ...
        super.setName("BottomNavigationActivity"
                + GraphHandler.getInstance().getActivityIndex(DragControllerType.bottomNavigationActivity,"BottomNavigationActivity"));
        loadInspector();
    }
    ...
    public java.util.List<MenuItem> getMenuItems(RootLayout root, DragContainer container, DraggableActivity target){
        ...
        if(target.getIngoingLinks().size()==0 && target.getType()!=DragControllerType.tabbedActivity
                ...
                && getOutgoingIntentsForType(IntentType.bottomNavigIntent).size()<=5){
