...
public class EmptyActivity extends DraggableActivity {
    ...
    public EmptyActivity() throws IOException {
        ...
        classTemplate = codeGenerator.provideTemplateForName("templates/activityTemplates/EmptyActivity");
        layoutTemplate = codeGenerator.provideTemplateForName("templates/activityTemplates/EmptyActivityLayout");
        fragmentTemplate = codeGenerator.provideTemplateForName("templates/activityTemplates/EmptyFragment");
    ...
    private void initialize() {
        ...
        super.setName("EmptyActivity"
                + GraphHandler.getInstance().getActivityIndex(DragControllerType.emptyActivity,"EmptyActivity"));
        loadInspector();
    }
