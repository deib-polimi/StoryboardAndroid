...
public class ButtonClickWithResultIntent extends Intent {
    ...
    public ButtonClickWithResultIntent(CubicCurve curve, float t, double radius, IntentType type) throws IOException {
        ...
        super.setName("ButtonClickWithResultIntent");
        buttonId = "";
        resultButtonId="resultButton";
        extraType = "None";
        resultExtra = "None";
        buttonText="";
        resultButtonText = "";
        ...
        classTemplate =codeGenerator.provideTemplateForName("templates/intentTemplates/ButtonClickForResultTemplate");
        setResult =codeGenerator.provideTemplateForName("templates/intentTemplates/ButtonClickSetResult");
    ...
    public String getOnResultCode() throws IOException {
        String template = codeGenerator.provideTemplateForName("templates/intentTemplates/ButtonClickResult");
        template = template.replace("${REQ_CODE}",Integer.toString(getRequestCode()));
        String extra = "";
        if(!resultExtra.equals("None")){
            extra= codeGenerator.provideTemplateForName("templates/intentTemplates/IntentExtraResult");
