...
public class BottomNavigationIntent extends Intent {
    ...
    public BottomNavigationIntent(CubicCurve curve, float t, double radius, IntentType type) throws IOException {
        ...
        super.setName("Item");
        icon = "Android";
        classTemplate = codeGenerator.provideTemplateForName("templates/intentTemplates/BottomNavigationItemSelection");
        navigationItemTemplate = codeGenerator.provideTemplateForName("templates/intentTemplates/NavigationItem");
