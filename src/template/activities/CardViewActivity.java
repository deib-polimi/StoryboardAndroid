...
public class CardViewActivity extends DraggableActivity {
    ...
    public CardViewActivity() throws IOException {
        ...
        classTemplate = codeGenerator.provideTemplateForName("templates/activityTemplates/CardViewActivity");
        classFragment = codeGenerator.provideTemplateForName("templates/activityTemplates/CardViewFragment");
        layoutTemplate = codeGenerator.provideTemplateForName("templates/activityTemplates/CardViewLayout");
        adapterTemplate = codeGenerator.provideTemplateForName("templates/activityTemplates/CardViewAdapter");
        modelTemplate = codeGenerator.provideTemplateForName("templates/activityTemplates/CustomAdapterModel");
        modelLayout = codeGenerator.provideTemplateForName("templates/activityTemplates/CardViewItemLayout");
        itemClickListenerTemplate = codeGenerator.provideTemplateForName("templates/activityTemplates/CardViewClickListener");
    ...
    private void initialize() {
        ...
        super.setName("CardViewActivity"
                + GraphHandler.getInstance().getActivityIndex(DragControllerType.cardView,"CardViewActivity"));
        layout = "List";
        columns = 2;
        loadInspector();
    }
    ...
    public void generateClickListener() throws IOException {
        ...
        codeGenerator.generateJavaFile(projectHandler.getProjectPath()+"/app/src/main/java/"
                +projectHandler.getPackagePath()+"/adapter/"+super.getName()+"ClickListener.java",template,super.getName()+"ClickListener");
    }
    ...
    public void generateCardLayout() throws IOException {
        ...
        codeGenerator.generateXMLFile(projectHandler.getProjectPath()+"/app/src/main/res/layout/"
                +generateLayoutName(super.getName())+"_card.xml",template,generateLayoutName(super.getName())+"_card");
    }
