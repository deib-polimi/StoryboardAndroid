...
public class FABIntent extends Intent {
    ...
    public FABIntent(CubicCurve curve, float t, double radius, IntentType type) throws IOException {
        ...
        super.setName("FloatingActionButtonIntent");
        extraType = "None";
        classTemplate = codeGenerator.provideTemplateForName("templates/intentTemplates/FABIntent");
        layoutTemplate =codeGenerator.provideTemplateForName("templates/intentTemplates/FABIntentLayout");
